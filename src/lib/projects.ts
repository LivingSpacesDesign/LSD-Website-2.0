...
export const projects: Project[] = [
  // ===== CONCEPT =====
  {
    ...
    team: 'LSD',
    description: {
      ro: 'Casa HH este cel mai ambițios proiect din portofoliul nostru — o rezidență cu 528 m² suprafață utilă pe un teren generos de 1722 m², în inima Moarii Vlăsiei. Arhitectura contemporană cu linii curate și volume generoase creează un dialog natural între interior și peisajul înconjurător. Cu 4 dormitoare, regim P+1, Casa HH oferă spațiu pentru o familie mare fără a sacrifica intimitatea. Grădina include un studio independent, bucătărie exterioară, fire pit, pistă de alergare, zonă de yoga și fitness, plus un home office separat — totul gândit pentru un mod de viață complet, la doar 20 de minute de centrul Bucureștiului.',
      en: 'Casa HH is the most ambitious project in our portfolio — a residence with 528 sqm of usable space on a generous 1722 sqm plot in the heart of Căciulati. The contemporary architecture with clean lines and generous volumes creates a natural dialogue between interior and surrounding landscape. With 4 bedrooms and P+1 configuration, Casa HH provides room for a large family without sacrificing privacy. The garden includes an independent studio, outdoor kitchen, fire pit, running track, yoga & fitness area, plus a separate home office — all designed for a complete lifestyle, just 20 minutes from central Bucharest.',
    },
  ...
  // ===== PERSONALIZATE =====
  {
    ...
    forSale: true,
    location: 'Căciulati, Ilfov',
    specs: { teren: '500 m²', casa: '178 m²', regim: 'P+1' },
    team: 'LSD',
    description: {
