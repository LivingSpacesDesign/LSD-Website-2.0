...
export function FeaturedProject() {
  ...
  return (
    <section className="relative w-full h-auto min-h-[500px] md:h-[90vh] overflow-hidden">
      {/* Background image */}
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col md:flex-row items-end justify-between h-full min-h-[500px] md:min-h-0 p-6 pb-12 md:p-12 md:pb-16">
        {/* Left — text */}
        <div className="flex-1">
          ...
          <ScrollReveal delay={100}>
            <h2 className="text-display text-[40px] md:text-[64px] text-cream">
              {project.name}
            </h2>
          </ScrollReveal>

          <ScrollReveal delay={200}>
            <p className="text-stone text-[14px] mt-3">
          ...
          <ScrollReveal delay={400}>
            <p className="text-cream-muted text-[15px] max-w-lg leading-relaxed">
              {t(
        ...
        {/* Right — specs grid (desktop) */}
        <div className="hidden md:grid grid-cols-2 gap-x-12 gap-y-6 ml-12">
          {project.specs.teren && (
            <ScrollReveal delay={300}>
              <div>
                <span className="text-display text-gold text-[32px]">
                  {project.specs.teren}
                </span>
                <p className="text-label text-ash mt-1">{t('Teren', 'Land')}</p>
              </div>
            </ScrollReveal>
          )}
          {project.specs.casa && (
